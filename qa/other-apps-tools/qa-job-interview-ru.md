...
![](../../aaa-assets/qa-job-interview-ru-1.png)

#### Классификация по доступу к коду и архитектурe
...
![](../../aaa-assets/qa-job-interview-ru-2.png)

Тест-дизайн — этап тестирования ПО, на котором проектируются и создаются тестовые случаи (тест-кейсы).
...
![](../../aaa-assets/qa-job-interview-ru-3.png)
